...
io.on('connection', socket => {
    ...
    socket.on('sendChat', function (data) {
        ...
        {              
               ...
               DATA.LuuTinNhanCoHinh(data.MaChat,MaChatVoiHinh,data.message,data.date,data.NguoiGui,data.NguoiNhan, DATA.LayURLHinhAnh()); 
        }        
    });
    socket.on('LuuHinhVeAWS',function(data){
        if(data.HinhAnh!=="undefined")
        {
            MaChatVoiHinh = data.PhatSinhMaChatTheoHinh;
             DATA.UploadAnhChat("C:/Users/Public/Pictures/" + data.HinhAnh,data.PhatSinhMaChatTheoHinh);
        }
    })
