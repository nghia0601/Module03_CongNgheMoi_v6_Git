...
const s3 = new AWS.S3({
  accessKeyId: 'AKIAJUD3YZOH6OKUCUSQ',
  secretAccessKey: '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',
...
var Global_LayAnh = {
  ...
  function UploadAnhChat(filename, MaHinh){
    const fileContent = fs.readFileSync(filename);
   // var MaHinh = PhatSinhMaChat();
    const params = {
        Bucket: 'congnghemoixanuforest',
        // Key: PhatSinhMaChat()+".png", // File name you want to save as in S3
        Key: String(MaHinh)+".png", // File name you want to save as in S3
        Body: fileContent,
        ACL: 'public-read'
    };
//  Uploading files to the bucket
      ...
      if (err) {
       ...
       console.log(`File uploaded successfully. ${data.Location}`);
        Global_LayAnh.HinhAnh = String(data.Location);
        // Global_LayAnh.KeyHinh = String(MaHinh);
    });
